...
import PayentOptionsIcon from '@/appIcons/payment_options.svg';
        ...
        {vendorSuccess ? <>
          ...
          <div className="flex flex-1 flex-col">
            ...
            <div className="flex flex-row flex-1 justify-between items-center border-t-8 border-stone-100 p-6">
              ...
              >
                <MinChargeIcon />
                <span className={`text-lg`}>{t('min_order_with_delivery')}</span>
              </div>
            ...
            <div className="flex flex-row flex-1 justify-between items-center border-t-8 border-stone-100 p-6">
              ...
              <div className="flex justify-center items-end">
                {vendorElement?.Data?.Payment_Methods.visa && (
                  <div className="">
            ...
            <div className="flex flex-row flex-1 justify-between items-center border-t-8 border-b-8 border-stone-100 p-6">
              ...
              >
                <ContactUsIcon />
                <span className={`text-lg`}>{t('contact_us')}</span>
              </div>
              <div className="flex justify-center items-end">
                {vendorElement?.Data?.facebook && (
                  <a href={vendorElement?.Data?.facebook} target={'_blank'} className="px-2">
                    <Facebook />
                  </a>
                )}
                {vendorElement?.Data?.instagram && (
                  <a href={vendorElement?.Data?.instagram} target={'_blank'} className="px-2">
                    <Instagram />
                  </a>
                )}
                {vendorElement?.Data?.twitter && (
                  <a href={vendorElement?.Data?.twitter} target={'_blank'} className="px-2">
                    <CustomImage
                      src={Twitter.src}
                      alt="twitter"
                      width={22}
